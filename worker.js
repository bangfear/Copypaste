...
// Variables
const rootDomain = "lulzx.my.id"; // Ganti dengan domain utama kalian
const serviceName = "zehahaha"; // Ganti dengan nama workers kalian
const apiKey = "d790408e8a929d94ca6c5c94cfacfc35a120f"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "bangfear1@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "c1bd7f9ca9de96dc3913e1dafe3c2e15"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "c11138de0f90212a646c2878f702cafc"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
